...
namespace ServiceWebsite.Web.Areas.Admin.Controllers
{
    public class FaqSettingController : AdminBaseController
    {
        ...
        public ActionResult Add(long languageId)
        {
            ...
            ViewData.TemplateInfo = new TemplateInfo { HtmlFieldPrefix = "FaqAdd" };
        ...
        public async Task<ActionResult> Add([Bind(Prefix = "FaqAdd")] FaqAddViewModel model)
        {
        ...
        public async Task<ActionResult> Edit(int faqId)
        {
            ...
            { 
                ViewData["Categories"] = _categoryService.GetFaqCategoryListIQueryable(model.LanguageId).ToList();
                ViewData.TemplateInfo = new TemplateInfo { HtmlFieldPrefix = "FaqEdit" };
        ...
        [HttpPost, ValidateInput(false), ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Prefix = "FaqEdit")] FaqEditViewModel model)
        { 
            if (ModelState.IsValid)
            {
