...
namespace ServiceWebsite.Web.Areas.Admin.Controllers
{
    ...
    public class PropertySettingController : AdminBaseController
    {
        ...
        public async Task<ActionResult> PropertiesList(PropertySearchViewModel model, int? page)
        {
        ...
        public ActionResult Add(long languageId)
        {
            ...
            ViewData.TemplateInfo = new TemplateInfo { HtmlFieldPrefix = "PropertyAdd" };
        ...
        public async Task<ActionResult> Add([Bind(Prefix = "PropertyAdd")] PropertyAddViewModel model)
        {
        ...
        public async Task<ActionResult> Edit(int propertyId)
        {
            ...
            if (model != null)
            {
                ViewData.TemplateInfo = new TemplateInfo { HtmlFieldPrefix = "PropertyEdit" };
        ...
        [HttpPost, ValidateInput(false), ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Prefix = "propertyEdit")] PropertyEditViewModel model)
        {
            HttpFileCollectionBase Files = Request.Files;
            HttpPostedFileBase ImageFile = Files[0];
            if (ImageFile != null && ImageFile.ContentLength > 0)
